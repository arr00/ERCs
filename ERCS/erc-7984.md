...
Smart contracts implementing the ERC-7984 standard MUST implement the ERC-165 `supportsInterface` function and MUST return the constant value `true` if `0x4958f2a4` is passed through the `interfaceID` argument.
